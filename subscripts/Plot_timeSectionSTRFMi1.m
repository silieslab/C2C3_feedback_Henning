...
function [Timing,timeEl]=Plot_timeSectionSTRFMi1(RF_DATA, NCON,Predicition_thres2,Rel_thres)

% cmap_max=load('/Volumes/SILIESLAB/MiriH/2p-imaging/Results_Impact_of_C2_on_MedullaNeurons/colormap_RF.mat')
...
for NCon=NCON%length(RF_DATA)
    ...
    % Plot timetrace for seperate Layer
