...
stimBox1=patch([0.7,0.7,1.45,1.45],[boxHeightminus,boxHeightplus,boxHeightplus,boxHeightminus],'k','FaceAlpha',.2,'EdgeColor','none');
stimBox2=patch([1.45,1.45,2.2,2.2],[boxHeightminus,boxHeightplus,boxHeightplus,boxHeightminus],'k','FaceAlpha',.35,'EdgeColor','none');
for gnum=1:M
    h=plot_err_patch(t,mean(squeeze(mrot(gnum,:,:)),1),...
            std(squeeze(mrot(gnum,:,:)),[],1)/sqrt(N),...
            cm(gnum,:),cm(gnum,:)+0.1);
